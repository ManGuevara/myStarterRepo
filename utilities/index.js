...
Util.buildClassificationList = async function (classification_id = null) {
    ...
    let classificationList =
      '<select name="classification_id" id="classificationList" class="form-select" required>'
...
module.exports = {handleErrors: Util.handleErrors,getNav:Util.getNav,buildClassificationGrid: Util.buildClassificationGrid, buildInventoryDetail, buildClassificationList: Util.buildClassificationList }